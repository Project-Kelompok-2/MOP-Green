...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	...
	$hum1 = $data["humadity1"];
	$hum2 = $data["humadity2"];
	$sql = "INSERT into `data_sensor` (temp1, temp2, hum1, hum2) VALUES ('$temp1', '$temp2', '$hum1', '$hum2')";
...
<body class="hold-transition dark-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
	...
	<div class="wrapper">
		...
		<div class="preloader flex-column justify-content-center align-items-center">
			<img class="animation__wobble" src="../img/logo2.png" height="250" width="250">
		</div>
		...
		<nav class="main-header navbar navbar-expand navbar-dark">
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block">
					<a href="../logout.php" class="nav-link"><?=$sesName;?> Logout</a>
				</li>
			</ul>
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="" class="brand-link">
				<img src="polije.png" class="brand-image img-circle elevation-3"
					style="opacity: .8">
  ...
  -----------------------------------------------------*/
		...
		client.onMessageArrived = function (message) {
            ...
            fetch('http://localhost/iot2/index.php', {
              method: 'POST', // or 'PUT'
            //   headers: {
